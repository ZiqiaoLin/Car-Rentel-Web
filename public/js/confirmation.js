...
const SUPABASE_URL = 'https://zxlrwpaqdodeeykrexpg.supabase.co';
const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inp4bHJ3cGFxZG9kZWV5a3JleHBnIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDc4Mzg5MzksImV4cCI6MjA2MzQxNDkzOX0.xCu5imrvD8wrUXaJ0opZ_MlbG3HUHWuOdGlClsi8TrY'
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.querySelectorAll('a').forEach(a => {
    a.addEventListener('click', e => {
      e.preventDefault();
      const href = a.href;
      cancelBooking().then(() => window.location.href = href);
    });
  });
